...
export default function HomePage() {
  ...
  const trustItems = [
    { text: 'Trusted by Hope Mills Families for Over a Decade', icon: trustIcons[0] },
    { text: 'Highly Rated on Google by Your Cumberland County Neighbors', icon: trustIcons[1] },
    { text: 'Same-Day Emergency Appointments Available', icon: trustIcons[2] },
    { text: 'Accepting Most Dental Insurance Plans', icon: trustIcons[3] },
  ];

  const services = [
    { title: 'Family & General Dentistry', desc: 'From first teeth to golden years, Corner Stone Family Dentistry provides comprehensive dental care for every member of your Hope Mills family. Routine cleanings, exams, and preventive treatments tailored to keep your smile healthy for life.', icon: serviceIcons[0] },
    { title: 'Cosmetic Dentistry', desc: 'Teeth whitening, veneers, and smile makeovers that give you the confidence to light up every room. Our cosmetic treatments are customized to complement your natural features and deliver results you will love showing off.', icon: serviceIcons[1] },
    { title: 'Emergency Dental Care', desc: 'Toothaches and dental emergencies do not wait for business hours. Hope Mills families count on Corner Stone for prompt, compassionate emergency care when it matters most.', icon: serviceIcons[2] },
    { title: 'Dental Implants & Restorations', desc: 'Missing teeth affect more than your smile — they impact how you eat, speak, and feel. Our implant and restoration solutions are designed to look, feel, and function like your natural teeth.', icon: serviceIcons[3] },
    { title: 'Pediatric Dentistry', desc: 'We make dental visits fun and stress-free for Hope Mills kids. Gentle cleanings, sealants, and early orthodontic evaluations set your child up for a lifetime of healthy smiles.', icon: serviceIcons[4] },
    { title: 'Invisalign & Orthodontics', desc: 'Straighten your teeth without the metal. Corner Stone offers Invisalign and modern orthodontic options for teens and adults who want a discreet path to a perfectly aligned smile.', icon: serviceIcons[5] },
  ];
  ...
  return (
    <>
      ...
      <nav className="nav" role="navigation" aria-label="Main navigation">
        <div className="nav-logo">{'Corner Stone Family Dentistry'}</div>
        <a
          href="tel:19104232030"
          className="nav-cta"
          aria-label="Call Corner Stone Family Dentistry at +1 910-423-2030"
        >
          <span
            dangerouslySetInnerHTML={{ __html: phoneIcon }}
            aria-hidden="true"
          />
          <span>{'+1 910-423-2030'}</span>
        </a>
      </nav>

      {/* HERO */}
      <section className="hero" aria-label="Welcome to Corner Stone Family Dentistry">
        ...
        <div className="hero-content">
          <span className="hero-badge">Trusted Dental Care in {'Hope Mills'}</span>
          <h1>Your Smile Deserves Gentle, Expert Dentistry</h1>
          <p>
            Welcome to {'Corner Stone Family Dentistry'} — where modern dental technology meets compassionate
      ...
      <section className="about" aria-label="About our practice">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay={2}>
            <h2>About {'Corner Stone Family Dentistry'}</h2>
            <p>{'Corner Stone Family Dentistry has been the dental home Hope Mills families turn to when quality care and genuine comfort matter. Located in the heart of the community, we combine advanced dental technology with the kind of personal attention you only find at a neighborhood practice. Whether you are bringing your child in for their first visit or finally getting the smile you have always wanted, Corner Stone is where Hope Mills comes to smile with confidence.'}</p>
      ...
      <section className="cta-section" aria-label="Contact us">
        <div className="cta-card" data-animate>
          <h2>Contact {'Corner Stone Family Dentistry'}</h2>
          <p>
          ...
          <a
            ...
            aria-label="Call Corner Stone Family Dentistry to schedule an appointment"
          >
            <span
              dangerouslySetInnerHTML={{ __html: phoneIcon }}
              aria-hidden="true"
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-content">
          <div className="footer-brand">
            <div className="footer-brand-name">{'Corner Stone Family Dentistry'}</div>
            <p>
              Providing quality dental care for families in {'Hope Mills'},{' '}
          ...
          <div className="footer-contact">
            <div className="footer-contact-item">
              ...
              />
              <span>
                {'3102 N Main St Suite 102, Hope Mills, NC 28348, USA'}, {'Hope Mills'}, {'NC'}
              </span>
            </div>
            <div className="footer-contact-item">
              <span
              ...
              <a
                href="tel:19104232030"
                aria-label="Call Corner Stone Family Dentistry"
        ...
        <div className="footer-bottom">
          &copy; {new Date().getFullYear()} {'Corner Stone Family Dentistry'}. All rights
          reserved.
        </div>
      </footer>
    </>
